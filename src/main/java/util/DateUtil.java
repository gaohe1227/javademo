...
public class DateUtil {
	...
	public static String getWeek(Date date){
		...
		switch(week){
		case 7: result=result+"星期日";
				break;
		case 1: result=result+"星期一";
			   break;
		case 2: result=result+"星期二";
			   break;
		case 3: result=result+"星期三";
			   break;
		case 4: result=result+"星期四";
			   break;
		case 5: result=result+"星期五";
			   break;
		case 6: result=result+"星期六";
			   break;
		}
		return result;
	}
